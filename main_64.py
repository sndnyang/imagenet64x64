...
parser.add_argument('-a', '--arch', metavar='ARCH', default='resnet18', choices=model_names, help='model architecture (default: resnet18)')
...
parser.add_argument("--decay_epochs", nargs="+", type=int, default=[50, 65, 75], help="decay learning rate by decay_rate at these epochs")
...
def validate(val_loader, model, criterion, args):
    ...
    with torch.no_grad():
        ...
        print(' * Loss {loss.avg:.4f} Acc@1 {top1.avg:.3f} Acc@5 {top5.avg:.3f}'.format(loss=losses, top1=top1, top5=top5))
